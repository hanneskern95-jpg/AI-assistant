...
class MockTool1(Tool):
    ...
    def run_tool(self, query: str, **kwargs) -> AnswerDict:
        """Run the mock tool."""
        self.last_query = query
        return {"answer_str": f"Mock tool 1 result for: {query}"}
...
class MockTool2(Tool):
    ...
    def run_tool(self, topic: str, **kwargs) -> AnswerDict:
        """Run the mock tool."""
        self.last_topic = topic
        return {"answer_str": f"Mock tool 2 result for: {topic}"}
...
class TestAssistant:
    ...
    def test_assistant_tool_dicts_format(self, assistant):
    ...
    def test_get_attributes_from_tool_call_message_valid_call(self, assistant):
    ...
    def test_get_attributes_from_tool_call_message_no_calls(self, assistant):
    ...
    def test_get_attributes_from_tool_call_message_no_function(self, assistant):
    ...
    def test_handle_tools_executes_tool(self, assistant):
        ...
        assert assistant.tools["mock_tool_1"].last_query == "test query"
        assert "Mock tool 1 result for: test query" == result["answer_str"]

    def test_handle_tools_appends_to_history(self, assistant):
    ...
    def test_handle_tools_with_no_tool_call(self, assistant):
    ...
    def test_chat_with_tool_appends_user_message(self, assistant):
        ...
        with patch.object(assistant.openai.chat.completions, "create") as mock_create:
            ...
            assistant.chat_with_tool("Hello assistant")
    ...
    def test_chat_with_tool_calls_openai_with_system_message(self, assistant):
        ...
        with patch.object(assistant.openai.chat.completions, "create") as mock_create:
            ...
            assistant.chat_with_tool("Test message")
    ...
    def test_chat_with_tool_handles_tool_call_response(self, assistant):
    ...
    def test_assistant_maintains_history(self, assistant):
        ...
        with patch.object(assistant.openai.chat.completions, "create") as mock_create:
            ...
            assistant.chat_with_tool("Message 1")
            assert len(assistant.history) == 2  # user + assistant
            
            assistant.chat_with_tool("Message 2")
            assert len(assistant.history) == 4  # 2 + user + assistant

    def test_handle_tools_stores_correct_tool_call_id(self, assistant):
