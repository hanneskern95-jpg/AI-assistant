...
class TestRecipeSuggestTool:
    ...
    def test_run_tool_with_valid_recipes(self, tool, mock_openai, sample_recipes):
        ...
        result = tool.run_tool("Italian pasta dishes")
    ...
    def test_run_tool_with_recipes_in_code_fences(self, tool, mock_openai, sample_recipes):
    ...
    def test_run_tool_with_invalid_json(self, tool, mock_openai):
    ...
    def test_run_tool_calls_openai_with_correct_parameters(self, tool, mock_openai, sample_recipes):
        ...
        tool.run_tool(test_description)
    ...
    def test_run_tool_with_single_recipe(self, tool, mock_openai):
    ...
    def test_is_recipe_type_guard_valid(self, tool):
    ...
    def test_is_recipe_type_guard_missing_field(self, tool):
    ...
    def test_is_recipe_type_guard_not_dict(self, tool):
        """Test that is_recipe rejects non-dict objects."""
        assert tool.is_recipe("not a dict") is False
        assert tool.is_recipe(None) is False
