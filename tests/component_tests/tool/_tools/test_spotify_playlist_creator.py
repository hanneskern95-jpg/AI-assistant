...
from tools.spotify_playlist_creator import SpotifyTool
...
class TestSpotifyTool:
    ...
    def test_run_tool_without_liked_songs(self, tool: SpotifyTool, mock_openai: MagicMock, sample_playlist: dict[str, Any]) -> None:
        ...
        with patch("tools.spotify_playlist_creator.spotify_playlist_creator.create_playlist") as mock_create:
    ...
    def test_run_tool_with_liked_songs(self, tool: SpotifyTool, mock_openai: MagicMock, sample_playlist: dict[str, Any]) -> None:
        ...
        with patch("tools.spotify_playlist_creator.spotify_playlist_creator.create_playlist") as mock_create:
            with patch("tools.spotify_playlist_creator.spotify_playlist_creator.catch_liked_songs", return_value=liked_songs):
    ...
    def test_run_tool_calls_openai_with_correct_model(self, tool: SpotifyTool, mock_openai: MagicMock, sample_playlist: dict[str, Any]) -> None:
        ...
        with patch("tools.spotify_playlist_creator.spotify_playlist_creator.create_playlist"):
    ...
    def test_run_tool_with_empty_liked_songs(self, tool: SpotifyTool, mock_openai: MagicMock, sample_playlist: dict[str, Any]) -> None:
        ...
        with patch("tools.spotify_playlist_creator.spotify_playlist_creator.create_playlist"):
            with patch("tools.spotify_playlist_creator.spotify_playlist_creator.catch_liked_songs", return_value=[]):
                result = tool.run_tool(
    ...
    def test_run_tool_caches_liked_songs(self, tool: SpotifyTool, mock_openai: MagicMock, sample_playlist: dict[str, Any]) -> None:
        ...
        with patch("tools.spotify_playlist_creator.spotify_playlist_creator.create_playlist"):
            with patch("tools.spotify_playlist_creator.spotify_playlist_creator.catch_liked_songs", return_value=liked_songs) as mock_catch:
                # First call
                tool.run_tool(
