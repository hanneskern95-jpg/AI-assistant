...
class TestWikipediaFactCheckerTool:
    ...
    def test_run_tool_with_conclusive_answer(self, tool, mock_openai):
        ...
        result = tool.run_tool("What is the capital of France?")
    ...
    def test_run_tool_with_inconclusive_answer(self, tool, mock_openai):
    ...
    def test_run_tool_with_no_article_found(self, tool, mock_openai):
        ...
        result = tool.run_tool("What is some made-up topic?")

        assert "answer_str" in result
        assert "No relevant Wikipedia article found" in result["answer_str"]

    def test_run_tool_with_json_in_code_fences(self, tool, mock_openai):
        ...
        result = tool.run_tool("Test question")
    ...
    def test_run_tool_calls_openai_with_correct_parameters(self, tool, mock_openai):
